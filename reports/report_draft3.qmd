...
# Prepare the data for modeling
data_vehicles <- read.csv("../data/Motor_Vehicle_Collisions_-_Vehicles_20230226.csv")

# Merge all three data sets on the common key COLLISION_ID
merged_data_all <- merge(merged_data, data_vehicles, by = "COLLISION_ID")

# Prepare the data for modeling using dplyr
