...
## Crash Percentage by Borough {.smaller auto-animate="true"}

<img src="./reports/figures/percentage-by-borough.png"/>

::: {.fragment .fade-in}
-   The frequency of crashes varies significantly across boroughs, with Brooklyn experiencing the highest number of crashes per capita. This insight is crucial for targeting interventions.
:::
...
-   Prior bias made us believe that most crashes occurred during the early morning hours when people could be returning from bars and events.
...
-   Within the weekdays, the evening rush hours are the most dangerous (8:00-9:00 AM and 4:00-6:00 PM)
:::
:::
:::
...
## **3. Fatal Crashes by Hour of Day** {.smaller auto-animate="true"}

<img src="./reports/figures/fatal-crashes-by-hour.png"/>

::: {.fragment .fade-in}
-   Reducing the time dimension to just the hour of the day, we see that fatal crashes are more prominent during the evening and night hours.
...
## Killer Plot {.smaller auto-animate="true"}
...
::: incremental
-   ***Temporal patterns***: Crashes are more frequent during the middle of the day and evening rush hours, with fatal crashes more prevalent during the evening and night hours.
...
-   ***Borough disparities***: Brooklyn has the highest crash frequency per capita, highlighting the need for targeted interventions in high-risk areas.
...
## Background on Models {.smaller auto-animate="true"}
...
::: footer
Source code available on [GitHub](https://github.com/micahkepe/stat405project)
:::
